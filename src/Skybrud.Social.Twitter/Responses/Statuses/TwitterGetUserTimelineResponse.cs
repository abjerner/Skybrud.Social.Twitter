...
namespace Skybrud.Social.Twitter.Responses.Statuses {
    ...
    public class TwitterGetUserTimelineResponse : TwitterResponse<TwitterStatusMessage[]> {
        ...
        private TwitterGetUserTimelineResponse(IHttpResponse response) : base(response) {
        ...
        public static TwitterGetUserTimelineResponse ParseResponse(IHttpResponse response) {
